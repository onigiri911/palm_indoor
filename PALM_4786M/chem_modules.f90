...
! Former revisions:
! -----------------
! $Id: chem_modules.f90 4581 2020-06-29 08:49:58Z suehring $
...
!
 MODULE chem_modules
    ...
    LOGICAL ::  constant_top_csflux(99)   = .TRUE.   !< internal flag, set to .FALSE. if no
                                                     !< top_csflux is prescribed
    ...
    LOGICAL ::  chem_debug0               = .FALSE.  !< namelist parameter: flag for minimum print
                                                     !< output
    LOGICAL ::  chem_debug1               = .FALSE.  !< namelist parameter: flag for print output
    LOGICAL ::  chem_debug2               = .FALSE.  !< namelist parameter: flag for further print
                                                     !< output
