...
! Former revisions:
! -----------------
! $Id: pmc_handle_communicator_mod.f90 4771 2020-11-04 13:12:46Z hellstea $
...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE pmc_get_model_info( comm_world_nesting, cpl_id, cpl_name, cpl_parent_id, lower_left_x, &
                                lower_left_y, ncpl, npe_total, request_for_cpl_id )
!
...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE read_coupling_layout( nesting_datatransfer_mode, nesting_mode,                         &
    ...
    NAMELIST /nesting_parameters/  domain_layouts,                                                 &
