...
! Former revisions:
! -----------------
! $Id: diffusion_v.f90 4674 2020-09-10 10:36:55Z pavelkrc $
...
!--       Natural-type surfaces, upward-facing
          ...
          DO  m = surf_s, surf_e
             ...
             tend(k,j,i) = tend(k,j,i) + ( - ( - surf_lsm_h(0)%vsws(m) ) ) * ddzw(k) * drho_air(k)
...
!--       Natural-type surfaces, downward-facing
          ...
          DO  m = surf_s, surf_e
             ...
             tend(k,j,i) = tend(k,j,i) + ( - surf_lsm_h(1)%vsws(m) ) * ddzw(k) * drho_air(k)
...
!--       Urban-type surfaces, upward-facing
          ...
          DO  m = surf_s, surf_e
             ...
             tend(k,j,i) = tend(k,j,i) + ( - ( - surf_usm_h(0)%vsws(m) ) ) * ddzw(k) * drho_air(k)
...
!--       Urban-type surfaces, downward-facing
          ...
          DO  m = surf_s, surf_e
             ...
             tend(k,j,i) = tend(k,j,i) + ( - surf_usm_h(1)%vsws(m) ) * ddzw(k) * drho_air(k)
