...
!--          WS1 (24), WS3 (25), WS5 (26)
             ...
             THEN
!
!--             Please note, at k == nzb_w_inner(j,i) a flag is explicitly set, although this is not
!--             a prognostic level. However, contrary to the advection of u,v and s this is
!--             necessary because flux_t(nzb_w_inner(j,i)) is used for the tendency at k ==
!--             0nzb_w_inner(j,i)+1.
