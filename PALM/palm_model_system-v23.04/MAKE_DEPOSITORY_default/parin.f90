...
! Former revisions:
! -----------------
! $Id: parin.f90 4783 2020-11-13 13:58:45Z raasch $
...
!------------------------------------------------------------------------------!
 SUBROUTINE parin
    ...
    NAMELIST /inipar/  alpha_surface, approximation, bc_e_b,     &
             ...
             canyon_wall_south, cfl_factor, check_realistic_q, cloud_droplets, &
             ...
             prandtl_number, psolver, pt_damping_factor,  pt_damping_width,    &
             pt_reference, pt_surface, pt_surface_heating_rate,                &
    ...
    NAMELIST /initialization_parameters/  alpha_surface,                       &
             ...
             omega_sor, outflow_source_plane, passive_scalar,                  &
             prandtl_number, psolver, pt_damping_factor, pt_damping_width,     &
             pt_surface_heating_rate, pt_reference, pt_surface,                &
             pt_surface_initial_change, pt_vertical_gradient,                  &
             pt_vertical_gradient_level, q_surface, q_surface_initial_change,  &
             q_vertical_gradient, q_vertical_gradient_level,                   &
             random_generator, random_heatflux, rans_const_c, rans_const_sigma,&
             ...
             recycling_method_for_thermodynamic_quantities, recycling_width,   &
             reference_state, residual_limit,                                  &
             restart_data_format, restart_data_format_input, restart_data_format_output,           &
             rotation_angle,                                                   &
...
!
!--    If not set by the user in the runtime parameters, the data format for restart
!--    input needs to be set now! This is normally done later in check parameters.
       IF ( TRIM( restart_data_format ) /= 'fortran_binary'  .AND.                           &
          ...
          CALL message( 'parin', 'PA0724', 1, 2, 0, 6, 0 )
       ENDIF
