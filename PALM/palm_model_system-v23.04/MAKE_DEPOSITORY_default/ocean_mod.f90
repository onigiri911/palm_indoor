...
! Former revisions:
! -----------------
! $Id: ocean_mod.f90 4768 2020-11-02 19:11:23Z suehring $
...
!------------------------------------------------------------------------------!
 SUBROUTINE ocean_rrd_global_mpi
    ...
    CALL rrd_mpi_io_global_array( 'wall_salinityflux', wall_salinityflux )
...
!------------------------------------------------------------------------------!
 SUBROUTINE ocean_wrd_global
    ...
    ELSEIF ( restart_data_format_output(1:3) == 'mpi' )  THEN
       ...
       CALL wrd_mpi_io_global_array( 'wall_salinityflux', wall_salinityflux )
