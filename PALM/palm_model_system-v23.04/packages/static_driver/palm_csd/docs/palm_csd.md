...
| `rotation_angle`             | float   | `0.0`  | Clockwise angle of rotation in degrees between North positive y axis and the y axis in the data, e.g. `0.0`. This value overwrites the namelist parameter of the PALM run.  |
...
| `lower_left_x`*              | float   |  | Distance (in m) along x-direction between the lower-left corner of the model domain and the lower-left corner of the input data. This parameter is used to shift the model domain with respect to the provided input data. |
| `lower_left_y`*              | float   |  | Distance (in m) along y-direction between the lower-left corner of the model domain and the lower-left corner of the input data. This parameter is used to shift the model domain with respect to the provided input data. |
